...
Дополнительный внешний вход — ChatGPT Custom Instructions. Они не хранят
текущий квест, а только указывают маршрут загрузки актуального состояния из
репозитория. Канонический текст и правила освежения контекста:
`DOCUMENTS/CUSTOM_INSTRUCTIONS_BYBITSCANNER.md`.
