...
- [ ] заменить оставшиеся startup gaps на bounded dependency readiness/fail-closed startup; backend fixed sleep закрыт PR #257, Robot admission health surface закрыт PR #258;
