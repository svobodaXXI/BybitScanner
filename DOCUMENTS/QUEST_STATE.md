...
- [ ] заменить оставшиеся startup gaps на bounded dependency readiness/fail-closed startup; backend PR #257, Robot admission PR #258, Robot/protection barrier PR #259, Telegram DB identity health PR #260, launcher Telegram/backend identity match PR #261;
